...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0453DA28;
	constexpr int32 AppendString      = 0x00F3AE20;
	constexpr int32 GNames            = 0x04525480;
	constexpr int32 GWorld            = 0x04676FA0;
	constexpr int32 ProcessEvent      = 0x01110D30;
