...
static_assert(offsetof(ADatasmithAreaLightActor, LightType) == 0x000220, "Member 'ADatasmithAreaLightActor::LightType' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, LightShape) == 0x000221, "Member 'ADatasmithAreaLightActor::LightShape' has a wrong offset!");
