...
static_assert(sizeof(UMovieSceneMediaPlayerPropertyTrack) == 0x0000B0, "Wrong size on UMovieSceneMediaPlayerPropertyTrack");
...
static_assert(sizeof(UMovieSceneMediaTrack) == 0x000090, "Wrong size on UMovieSceneMediaTrack");
static_assert(offsetof(UMovieSceneMediaTrack, MediaSections) == 0x000080, "Member 'UMovieSceneMediaTrack::MediaSections' has a wrong offset!");
