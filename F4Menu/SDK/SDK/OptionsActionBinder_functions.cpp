...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    bRemoveOld                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
// Parameters:
// struct FInputChord                      InInputChord                                           (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
// bool                                    bIsWaitingForInput                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
// bool                                    bIsBlacklisted                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
// Parameters:
// struct FKey                             InKey                                                  (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
// bool                                    bIsShift                                               (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                                    bIsCtrl                                                (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                                    bIsAlt                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                                    bIsCmd                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
// bool                                    IsNotSame                                              (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
