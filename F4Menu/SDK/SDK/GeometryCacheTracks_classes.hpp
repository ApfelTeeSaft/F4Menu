...
static_assert(sizeof(UMovieSceneGeometryCacheTrack) == 0x000090, "Wrong size on UMovieSceneGeometryCacheTrack");
static_assert(offsetof(UMovieSceneGeometryCacheTrack, AnimationSections) == 0x000080, "Member 'UMovieSceneGeometryCacheTrack::AnimationSections' has a wrong offset!");
