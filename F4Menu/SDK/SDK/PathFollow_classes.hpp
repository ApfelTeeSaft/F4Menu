...
public:
	...
	bool EventPointExistByName(const class FName& Name_0);
	void FollowPath(float FollowStep);
	struct FEventPoint GetEventPointByName(const class FName& Name_0);
	class UEventPointDelegateHolder* GetEventPointDelegateAll();
	class UEventPointDelegateHolder* GetEventPointDelegateByIndex(int32 Index_0);
	class UEventPointDelegateHolder* GetEventPointDelegateByName(const class FName& Name_0);
	...
	void Pause();
	void Reverse(bool Reverse_0);
	void SetCurrentDistance(float NewDistance);
	void SetPathOwner(class AActor* PathOwner_0);
	void SetPathToFollow(class USplineComponent* Spline);
	void Start(float StartDelay_0);
	void StartImpl();
	void Stop();
