...
static_assert(offsetof(CreateSessionCallbackProxyAdvanced_CreateAdvancedSession, bAllowJoinViaPresence) == 0x00002C, "Member 'CreateSessionCallbackProxyAdvanced_CreateAdvancedSession::bAllowJoinViaPresence' has a wrong offset!");
static_assert(offsetof(CreateSessionCallbackProxyAdvanced_CreateAdvancedSession, bAllowJoinViaPresenceFriendsOnly) == 0x00002D, "Member 'CreateSessionCallbackProxyAdvanced_CreateAdvancedSession::bAllowJoinViaPresenceFriendsOnly' has a wrong offset!");
static_assert(offsetof(CreateSessionCallbackProxyAdvanced_CreateAdvancedSession, bAntiCheatProtected) == 0x00002E, "Member 'CreateSessionCallbackProxyAdvanced_CreateAdvancedSession::bAntiCheatProtected' has a wrong offset!");
static_assert(offsetof(CreateSessionCallbackProxyAdvanced_CreateAdvancedSession, bUsesStats) == 0x00002F, "Member 'CreateSessionCallbackProxyAdvanced_CreateAdvancedSession::bUsesStats' has a wrong offset!");
static_assert(offsetof(CreateSessionCallbackProxyAdvanced_CreateAdvancedSession, bShouldAdvertise) == 0x000030, "Member 'CreateSessionCallbackProxyAdvanced_CreateAdvancedSession::bShouldAdvertise' has a wrong offset!");
