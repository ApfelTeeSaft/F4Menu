...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UOptionsSlider_C*                 InOptionsSlider                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                                   InValue                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UControlsSettingsContainerWidgetBP_C::SetSensivitySliderValue(class UOptionsSlider_C* InOptionsSlider, float InValue)
{
	static class UFunction* Func = nullptr;
...
// bool                                    bIsGamepadMapping                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UControlsSettingsContainerWidgetBP_C::RemoveAxisMappingByName(class FName InAxisName, float InScale, bool bIsGamepadMapping)
{
	static class UFunction* Func = nullptr;
...
void UControlsSettingsContainerWidgetBP_C::OnNavigationEnter(class UInteractableMenuWidgetBP_C* NavigateFromMenu, bool Param_bIsGamepadBeingUsed)
{
	static class UFunction* Func = nullptr;
