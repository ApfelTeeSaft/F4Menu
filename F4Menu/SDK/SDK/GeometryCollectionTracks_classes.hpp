...
static_assert(sizeof(UMovieSceneGeometryCollectionTrack) == 0x000090, "Wrong size on UMovieSceneGeometryCollectionTrack");
static_assert(offsetof(UMovieSceneGeometryCollectionTrack, AnimationSections) == 0x000080, "Member 'UMovieSceneGeometryCollectionTrack::AnimationSections' has a wrong offset!");
